...
const { dialog, loading, errorMessage, form, almacenSeleccionado, abrirModal, editarAlmacen } = useEditarAlmacen((almacen) => {
  emit("almacenEditado", almacen);
});
    ...
    <v-card class="modal-card" theme="light">
      ...
      <div class="modal-form">
        ...
        <div class="form-group full-width">
          ...
          <v-text-field v-model="form.nombre_almacen" placeholder="Ej. Almacén Central"
        ...
        <div class="form-group full-width">
          ...
          <v-textarea v-model="form.descripcion" variant="outlined"
            density="comfortable" hide-details="auto" rows="3" />
        </div>
      ...
      <div class="modal-actions">
        ...
        <v-btn class="save-btn" :loading="loading" @click="editarAlmacen">
