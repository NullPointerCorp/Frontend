...
import { useRegistrarEmpleado } from "@/composables/useRegistrarEmpleado";
...
const { form, resetForm, registrarEmpleado, validate, validateAll, fetchRoles, fetchSucursales } = useRegistrarEmpleado();
...
const guardar = async () => {
  ...
  try {
    ...
    showToast(`Empleado \"${form.nombre} ${form.apellido_paterno}\" registrado exitosamente`, "success");
    cancelar();
  } catch (error: any) {
